...
export const rxFalse = <S extends Subject<boolean>>(...subjects: S[]) => rxNext_(...subjects)(false);
...
export const rxTrue = <S extends Subject<boolean>>(...subjects: S[]) => rxNext_(...subjects)(true);
