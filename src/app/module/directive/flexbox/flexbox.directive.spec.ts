...
const testsFlexbox: TestingGround[] = [
  ...
  })),
  {
    info: 'multiple',
    param: 'vycw',
    styles: {...STYLE_DEFAULT_FLEXBOX, flexDirection: 'column', alignItems: 'center', flexWrap: 'wrap'},
  },
  {
    info: 'multiple spaced',
    param: ' v yc   w  ',
    styles: {
      ...STYLE_DEFAULT_FLEXBOX,
...
const testsFlexitem: TestingGround[] = [
  ...
  {info: 'multiple', param: 'as1 2 300px', styles: {...STYLE_DEFAULT_FLEXITEM, alignSelf: 'flex-start', flex: '1 2 300px'}},
  {
    info: 'multiple spaced',
    param: ' as  1 2 300px    ',
    styles: {...STYLE_DEFAULT_FLEXITEM, alignSelf: 'flex-start', flex: '1 2 300px'},
  },
];
...
describe('FlexboxDirective: parameter', () => {
  ...
  test('should have target container', () => {
